...
Install [Apache JMeter 5.6.3](https://jmeter.apache.org/download_jmeter.cgi) locally (not stored in this repo), then:

```powershell
$env:JAVA_HOME = "C:\Program Files\Microsoft\jdk-17.0.20.101-hotspot"
jmeter -n -t "NFR_EVIDENCE\jmeter\vu-voting-hd-load.jmx" -l "NFR_EVIDENCE\jmeter\results\rerun.jtl" -e -o "NFR_EVIDENCE\jmeter\results\html-report-rerun"
```
