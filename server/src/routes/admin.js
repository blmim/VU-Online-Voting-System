...
const { dedupeCandidates } = require('../utils/dedupeCandidates');
      ...
      activeElections.map(async (e) => {
        try {
          ...
          return {
            electionId: e._id,
            title: e.title,
            turnoutPct: live.turnoutPct,
            uniqueVoterCount: live.uniqueVoterCount,
            totalEligibleVoters: live.totalEligibleVoters,
          };
        } catch (err) {
          console.error(`Dashboard turnout error (${e._id}):`, err.message);
          return {
            electionId: e._id,
            title: e.title,
            turnoutPct: 0,
